...
public class CrmOrderRespVO {
    ...
    @Schema(description = "订单名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "王五")
    @ExcelProperty("订单名称")
    private String name;

    @Schema(description = "订单编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "20230101")
    @ExcelProperty("订单编号")
    private String no;
