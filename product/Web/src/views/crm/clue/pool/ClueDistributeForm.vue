<template>
  <Dialog v-model="dialogVisible" :title="t('clue.assignTitle')">
    <el-form
      ref="formRef"
...
const submitForm = async () => {
  ...
  try {
    await ClueApi.distributeClue({ ids: [formData.value.id as number], ownerUserId: formData.value.ownerUserId as number })
    message.success(t('clue.assignSuccess'))
