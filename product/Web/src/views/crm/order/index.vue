  ...
  <ContentWrap>
    ...
    <el-table v-loading="loading" :data="list" :show-overflow-tooltip="true" :stripe="true" :table-layout="'auto'">
      ...
      <el-table-column
        ...
        :formatter="dateFormatter2"
      />
      <el-table-column align="center" :label="t('crm.order.signContactName')" prop="signContactName" min-width="130">
        <template #default="scope">
          <el-link
            :underline="false"
            type="primary"
      ...
      <el-table-column align="center" :label="t('crm.order.signUserName')" prop="signUserName" min-width="130" />
      <el-table-column align="center" :label="t('crm.order.remark')" prop="remark" min-width="200" />
      <el-table-column
        align="center"
        :label="t('crm.order.totalReceivablePrice') + '（元）'"
      ...
      <el-table-column
        align="center"
        :label="t('crm.order.unreceivablePrice') + '（元）'"
        prop="totalReceivablePrice"
        min-width="140"
        :formatter="erpPriceTableColumnFormatter"
      >
      ...
      <el-table-column
        ...
        align="center"
        :label="t('crm.order.contactLastTime')"
      ...
      <el-table-column align="center" fixed="right" :label="t('crm.order.auditStatus')" prop="auditStatus" min-width="120">
        <template #default="scope">
