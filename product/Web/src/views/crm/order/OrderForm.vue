<template>
  <Dialog v-model="dialogVisible" :title="dialogTitle" width="1280">
    ...
    >
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="t('crm.order.businessName')" prop="businessId">
            <el-select
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item :label="t('crm.order.startTime')" prop="startTime">
            <el-date-picker
              v-model="formData.startTime"
              :placeholder="t('crm.order.startTimePlaceholder')"
              type="date"
              value-format="x"
              class="!w-1/1"
            />
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="t('crm.order.endTime')" prop="endTime">
            <el-date-picker
              v-model="formData.endTime"
              :placeholder="t('crm.order.endTimePlaceholder')"
              type="date"
              value-format="x"
              class="!w-1/1"
            />
        ...
        <el-col :span="12">
          <el-form-item :label="t('crm.order.orderType')" prop="orderType">
            <el-select v-model="formData.orderType" class="w-1/1">
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="t('crm.order.paymentMethod')" prop="paymentMethod">
            <el-select v-model="formData.paymentMethod" class="w-1/1">
        ...
        <el-col :span="12">
          <el-form-item :label="t('crm.order.signUserId')" prop="signUserId">
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="t('crm.order.signContactId')" prop="signContactId">
            <el-select
    ...
    <template #footer>
      <el-button :disabled="formLoading" type="primary" @click="submitForm">{{ t('crm.order.save') }}</el-button>
